...
extension DomWindowExtension on DomWindow {
  ...
  @JS('postMessage')
  external JSVoid _postMessage2(JSAny message, JSString targetOrigin, JSArray messagePorts);
...
extension DomEventTargetExtension on DomEventTarget {
  ...
  @JS('addEventListener')
  external JSVoid _addEventListener3(JSString type, DomEventListener listener, JSAny options);
  void addEventListenerWithOptions(
          String type, DomEventListener listener, Map<String, Object> options) =>
      _addEventListener3(type.toJS, listener, options.toJSAnyDeep);

  @JS('removeEventListener')
  external JSVoid _removeEventListener1(JSString type, DomEventListener listener);
  @JS('removeEventListener')
...
extension DomEventExtension on DomEvent {
  ...
  @JS('initEvent')
  external JSVoid _initEvent3(JSString type, JSBoolean bubbles, JSBoolean cancelable);
...
extension DomElementExtension on DomElement {
  ...
  JSVoid setAttribute(String name, Object value) => _setAttribute(name.toJS, value.toJSAnyDeep);
...
extension DomCanvasRenderingContext2DExtension on DomCanvasRenderingContext2D {
  ...
  external DomCanvasGradient _createRadialGradient(
      JSNumber x0, JSNumber y0, JSNumber r0, JSNumber x1, JSNumber y1, JSNumber r1);
  ...
  @JS('drawImage')
  external JSVoid _drawImage(DomCanvasImageSource source, JSNumber destX, JSNumber destY);
  ...
  @JS('fillRect')
  external JSVoid _fillRect(JSNumber x, JSNumber y, JSNumber width, JSNumber height);
  ...
  @JS('fillText')
  external JSVoid _fillText2(JSString text, JSNumber x, JSNumber y, JSNumber maxWidth);
  ...
  @JS('rect')
  external JSVoid _rect(JSNumber x, JSNumber y, JSNumber width, JSNumber height);
  ...
  @JS('clearRect')
  external JSVoid _clearRect(JSNumber x, JSNumber y, JSNumber width, JSNumber height);
  ...
  external JSVoid _bezierCurveTo(
      JSNumber cp1x, JSNumber cp1y, JSNumber cp2x, JSNumber cp2y, JSNumber x, JSNumber y);
  void bezierCurveTo(num cp1x, num cp1y, num cp2x, num cp2y, num x, num y) =>
      _bezierCurveTo(cp1x.toJS, cp1y.toJS, cp2x.toJS, cp2y.toJS, x.toJS, y.toJS);

  @JS('quadraticCurveTo')
  external JSVoid _quadraticCurveTo(JSNumber cpx, JSNumber cpy, JSNumber x, JSNumber y);
  ...
  @JS('arc')
  external JSVoid _arc(JSNumber x, JSNumber y, JSNumber radius, JSNumber startAngle,
      JSNumber endAngle, JSBoolean antiClockwise);
  ...
  @JS('ellipse')
  external JSVoid _ellipse(JSNumber x, JSNumber y, JSNumber radiusX, JSNumber radiusY,
      JSNumber rotation, JSNumber startAngle, JSNumber endAngle, JSBoolean? antiClockwise);
  void ellipse(num x, num y, num radiusX, num radiusY, num rotation, num startAngle, num endAngle,
          bool? antiClockwise) =>
      _ellipse(x.toJS, y.toJS, radiusX.toJS, radiusY.toJS, rotation.toJS, startAngle.toJS,
          endAngle.toJS, antiClockwise?.toJS);
...
DomXMLHttpRequest createDomXMLHttpRequest() =>
    domCallConstructorString('XMLHttpRequest', <Object?>[])! as DomXMLHttpRequest;
...
extension DomXMLHttpRequestExtension on DomXMLHttpRequest {
  ...
  void open(String method, String url, [bool? async]) =>
      js_util.callMethod(this, 'open', <Object>[method, url, if (async != null) async]);
  void send([Object? bodyOrData]) =>
      js_util.callMethod(this, 'send', <Object>[if (bodyOrData != null) bodyOrData]);
}
...
Future<HttpFetchResponse> httpFetch(String url) async {
  ...
  try {
    final ByteData result = await load(url);
...
extension DomHTMLTextAreaElementExtension on DomHTMLTextAreaElement {
  ...
  @JS('setSelectionRange')
  external JSVoid _setSelectionRange2(JSNumber start, JSNumber end, JSString direction);
...
typedef DomMutationCallback = void Function(JSArray mutation, DomMutationObserver observer);
...
extension DomResizeObserverExtension on DomResizeObserver {
  external JSVoid disconnect();
  external JSVoid observe(DomElement target, [DomResizeObserverObserveOptions options]);
...
final DomTrustedTypePolicy _ttPolicy = domWindow.trustedTypes!.createPolicy(
  ...
  DomTrustedTypePolicyOptions(
    ...
    domWindow.console.error('URL rejected by TrustedTypes policy flutter-engine: $url'
        '(download prevented)');
